  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <NavBar title={title.toUpperCase()} onBackPress={() => this.props.navigation.goBack()} />
        <ScrollView contentContainerStyle={styles.gridView}>
          <ActionBar firstButtonText={'SORT  ▼ '} secondButtonText={'filter'} onButtonSelect={(s) => this.buttonSelected(s)} />
