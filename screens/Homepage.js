...
import { extraLightBackground, lightBackground } from '../components/AsosColors';
...
class Homepage extends Component {
  ...
  render() {
    return (
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ width: width, backgroundColor: 'white' }}>
        ...
        <View style={{ marginHorizontal: kHorizontalMargin }}>
          ...
          >
            <Image style={{ marginTop: 30 }} source={require('../assets/images/clock-white-on-pink.gif')} />
            <Text style={{ fontFamily: 'futura', fontSize: 26, fontWeight: '900', color: 'white', textAlign: 'center' }}>UP TO 60% OFF COLD WEATHER</Text>
          ...
          >
            <ImageBackground style={{ flex: 1, height: null, width: null, resizeMode: 'cover' }} source={salesBanner}>
              <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ fontFamily: 'futura', fontSize: 26, fontWeight: '900', color: 'white', textAlign: 'center' }}>Party like an animal</Text>
...
const newSeason = 'http://content.asos-media.com/~/media/300317024542en-GB/mw-homepage/2017/April/0' + '3/jeans_hero_moment_mw_app.jpg';
...
const freeDelivery =
  'http://content.asos-media.com/~/media/191216102247en-GB/unisex/Free-worldwide-delivery-service-messages/App/iphone/freedelivery-service-message-iphone-1024x138_UK.png';
const salesBanner2 = 'http://content.asos-media.com/~/media/040417100631en-GB/mw-homepage/2017/April/1' + '1/App/mw-INT-mss-iphone-1024x672-week2.jpg';
const recommendationBanner =
  'http://content.asos-media.com/~/media/100217042313en-GB/asosapp/homepage/SERVICE_MESSAGES_FEB17/v2-unisex-rec-iphone-1024x380-v1.png';
